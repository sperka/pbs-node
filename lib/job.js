...
Job.prototype.enqueue = function(callback) {
	...
	// output path
	if(!this.isPropNA(this.outputPath)) {
		params.push('-o');
		params.push(this.outputPath);
	}

	// error path
	if(!this.isPropNA(this.errorPath)) {
		params.push('-e');
		params.push(this.errorPath);
	}

	// working dir
	if(!this.isPropNA(this.workingDir)) {
		params.push('-d');
		params.push(this.workingDir);
	}
	if(!this.isPropNA(this.rootDir)) {
		params.push('-D');
		params.push(this.rootDir);
	}
