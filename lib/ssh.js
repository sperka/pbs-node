...
SSH.prototype.scpDownloadDirProc = function(remotePath, localPath) {
	var scpParams = [], remote, proc, switchKey, options = this.options;
...
SSH.prototype.scpDownloadDir = function(remotePath, localPath, callback) {
	var proc = this.scpDownloadDirProc(remotePath, localPath);
	this.listenProc(proc, callback);
}
